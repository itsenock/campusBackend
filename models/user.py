...
# Connect to MongoDB
client = MongoClient(os.getenv('MONGO_URI', 'mongodb://itsenock254:2467havoc@cluster0-shard-00-00.dadth.mongodb.net:27017/user_database?ssl=true&replicaSet=atlas-tvdsu5-shard-0&authSource=admin&retryWrites=true&w=majority'))
